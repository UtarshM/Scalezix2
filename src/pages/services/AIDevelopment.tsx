...
import { Cpu, ArrowRight, CheckCircle, MessageSquare, Eye, BarChart3, Cog } from 'lucide-react';
  ...
  const solutions = [
    {
      ...
      features: ["Natural Language Understanding", "Multi-language Support", "Integration with CRM", "24/7 Availability"]
    },
    {
      title: "Predictive Analytics",
      description: "Machine learning models for business forecasting",
      features: ["Sales Forecasting", "Demand Prediction", "Risk Assessment", "Customer Behavior Analysis"]
    },
    {
      title: "Computer Vision",
    ...
    },
    {
      ...
      features: ["Document Processing", "Data Entry Automation", "Workflow Optimization", "Decision Making"]
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-indigo-600 font-semibold">AI Development</span>
              </div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Build intelligent applications with custom AI solutions. We develop machine learning models, 
                chatbots, and intelligent automation systems tailored to your specific business needs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive AI development services to build intelligent applications
            </p>
          </div>
      ...
      <section className="py-20 bg-indigo-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-3xl mx-auto">
            Let's create intelligent applications that automate processes and drive business growth
          </p>
