...
import { Search, ArrowRight, CheckCircle, TrendingUp, Users, Target, Mail, BarChart2, Facebook, Instagram, Linkedin, PieChart, Mail as MailIcon, Activity, Zap } from 'lucide-react';
...
const DigitalMarketing = () => {
  ...
  const platforms = [
    { name: "Google Ads", category: "PPC", icon: <BarChart2 className="w-8 h-8 text-blue-500 mx-auto" /> },
    { name: "Facebook Ads", category: "Social", icon: <Facebook className="w-8 h-8 text-blue-600 mx-auto" /> },
    { name: "Instagram Ads", category: "Social", icon: <Instagram className="w-8 h-8 text-pink-500 mx-auto" /> },
    { name: "LinkedIn Ads", category: "B2B", icon: <Linkedin className="w-8 h-8 text-blue-700 mx-auto" /> },
    { name: "Google Analytics", category: "Analytics", icon: <PieChart className="w-8 h-8 text-yellow-500 mx-auto" /> },
    { name: "SEMrush", category: "SEO", icon: <Activity className="w-8 h-8 text-orange-500 mx-auto" /> },
    { name: "Mailchimp", category: "Email", icon: <MailIcon className="w-8 h-8 text-yellow-600 mx-auto" /> },
    { name: "HubSpot", category: "CRM", icon: <Zap className="w-8 h-8 text-orange-400 mx-auto" /> },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {platforms.map((platform, index) => (
              <div key={index} className="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center border border-gray-100 flex flex-col items-center">
