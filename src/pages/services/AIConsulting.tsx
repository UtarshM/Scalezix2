...
import { Brain, ArrowRight, CheckCircle, Target, TrendingUp, Users, Lightbulb } from 'lucide-react';
...
const AIConsulting = () => {
  ...
  const useCases = [
    ...
    {
      industry: "Retail",
      applications: ["Recommendation Systems", "Inventory Optimization", "Price Optimization", "Customer Analytics"]
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-purple-600 font-semibold">AI Consulting</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                AI Strategy & <span className="text-purple-600">Consulting</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Transform your business with strategic AI consulting. We help organizations identify 
                AI opportunities, develop implementation strategies, and navigate the AI transformation journey.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Navigate your AI transformation with expert guidance and strategic planning
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Discover how AI can transform different industries and business functions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">{useCase.industry}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Leveraging the latest AI technologies and platforms for your solutions
            </p>
          </div>
      ...
      <section className="py-20 bg-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
            Let's develop a strategic AI roadmap that aligns with your business goals and drives innovation
          </p>
