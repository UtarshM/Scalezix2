          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-green-500 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-white font-semibold text-sm sm:text-base">Startup India Certified</h4>
                  <p className="text-orange-100 text-xs sm:text-sm">Government of India Recognition</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300 text-sm sm:text-base">hello@scalezix.com</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400" />
                <span className="text-gray-300 text-sm sm:text-base">+91 8200010241</span>
              </div>
              <div className="flex items-center gap-3">
