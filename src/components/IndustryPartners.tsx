        ...
        <div className="relative">
          <div className="flex animate-scroll-fast space-x-8 sm:space-x-12 lg:space-x-16">
            {[...partners, ...partners].map((partner, index) => (
              <div 
                key={index}
                className="flex-shrink-0 bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 min-w-[240px] sm:min-w-[280px] lg:min-w-[320px] transform hover:-translate-y-1"
              >
                <div className="text-center">
                  <div className="h-12 sm:h-14 lg:h-16 flex items-center justify-center mb-3 sm:mb-4">
                    <img 
                      src={partner.logo} 
                      alt={partner.name}
                      className="max-h-8 sm:max-h-10 lg:max-h-12 max-w-24 sm:max-w-28 lg:max-w-32 object-contain"
                    />
                  </div>
